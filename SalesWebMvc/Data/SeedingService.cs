...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d4 = new Department(4, "Electronics");

            Seller s1 = new Seller(1, "Pedro Albuquerque", "pgsa@cin.ufpe.br", new DateTime(2001, 11, 14), 400.0, d1);
            Seller s2 = new Seller(2, "Gloria Monique", "gmns@cin.ufpe.br", new DateTime(2001, 9, 13), 600.0, d2);
            Seller s3 = new Seller(3, "William Diego", "wd@cin.ufpe.br", new DateTime(2001, 7, 24), 400.0, d4);
            Seller s4 = new Seller(4, "Pedro Roseno", "phrbs@cin.ufpe.br", new DateTime(2001, 10, 22), 1000.0, d3);
            Seller s5 = new Seller(5, "Guilherme Santiago", "gss9@cin.ufpe.br", new DateTime(2000, 4, 12), 600.0, d1);
            Seller s6 = new Seller(6, "Joao Guedes", "jg@cin.ufpe.br", new DateTime(1999, 7, 1), 600.0, d4);
